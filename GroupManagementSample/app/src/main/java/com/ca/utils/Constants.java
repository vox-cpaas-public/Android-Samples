...
public class Constants {
    ...
    // Create Group screen
    public static int CAMERA_OPEN_INTENT=221;
    public static int GALLEY_OPEN_INTENT=999;
    public static int SELECT_CONTACT_INTENT=891;
    public static int EDIT_GROUP_INTNET=823;
